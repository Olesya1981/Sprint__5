...
#MainPage:
CONSTRUCTOR_BUTTON = (By.XPATH, ".//html/body/div/div/header/nav/ul/li[1]/a") #кнопка Конструктор на главной
CONSTRUCT_BURGER = (By.XPATH, ".//h1[text() = 'Соберите бургер']") #блок соберите бургер на главной странице
CONSTRUCT_BURGER_XPATH = (By.XPATH, '/html/body/div/div/main/section[1]/h1') #блок соберите бургер по XPATH
ORDER_FEED = (By.XPATH,"/html/body/div/div/header/nav/ul/li[2]/a") #кнопка Лента Заказов на главной
...
REGISTRATION_EMAIL_BUTTON = (By.XPATH, "/html/body/div/div/main/div/form/fieldset[2]/div/div/input") #поле ввода Email
...
ENTER_FORM = (By.XPATH, "./html/body/div/div/main/div/h2[text() = 'Вход']") #вход на странице входа в аккаунт
...
REMEMBER_PASSWORD_LOGIN_BUTTON = (By.XPATH, ".//a[@class= 'Auth_link__1fOlj' and @href ='/login' and text() = 'Войти']")#кнопка "вспомнили пароль?"
#<a class="Auth_link__1fOlj" href="/login">Войти</a>
...
BUNS_CLASS_AFTER_CLICK = (By.XPATH, ".//*[@class= 'tab_tab__1SPyG tab_tab_type_current__2BEPc pt-4 pr-10 pb-4 pl-10 noselect']")
BUNS_CLASS = (By.XPATH, "/html/body/div/div/main/section[1]/div[1]/div[1]")
SAUCES_CLASS = (By.XPATH, "/html/body/div/div/main/section[1]/div[1]/div[2]")
TOPPINGS_CLASS = (By.XPATH, "/html/body/div/div/main/section[1]/div[1]/div[3]")
